...
const screenshotPage = () => {
    ...
    const itm = document.getElementById("map").firstChild;
    let screenshot = itm.cloneNode(true);
...
export { screenshotPage, generate };
